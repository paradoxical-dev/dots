    		...
    		opts = {
    			...
    			custom_highlights = function(colors)
    				...
    				return {
    					...
    					FloatTitle = { fg = colors.teal, bold = true, italic = true },
    					...
    					DiagnosticSignHint = { fg = colors.muave },
    					DiagnosticVirtualTextHint = { fg = colors.muave, bg = "#27312F", bold = true, italic = true },
    					DiagnosticHint = { fg = colors.muave },
    					...
    					LazyButtonActive = { bg = colors.muave, fg = colors.mantle, bold = true, italic = true },
